...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sourceStationName = $_POST["sourceStationName"];
    $DestinationStationName=$_POST["DestinationStationName"];
...
WHERE search.sourceStationName LIKE CONCAT('%', ?, '%') AND search.DestinationStationName LIKE CONCAT('%', ?, '%')";

echo "Source Station: " . $sourceStationName . "<br>";
echo "Destination Station: " . $DestinationStationName . "<br>";
    
    // Prepare and bind parameters
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "ss", $sourceStationName,$DestinationStationName);
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        echo "No train found for the given train source and destination names";
    }
